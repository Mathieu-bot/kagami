...
STRINGS = {
    "fr": {
        ...
        "common.export_csv": "Exporter les données (CSV)",
        "common.download_csv": "Télécharger le CSV",
        ...
        "sidebar.sign_out": "Se déconnecter",        "sidebar.public_viewer": "Visiteur public — données ouvertes",
        "sidebar.navigation": "Navigation",
        "sidebar.subtitle": "Qualité de l'air · Madagascar",
        "sidebar.filters": "Filtres",
        "sidebar.language": "Langue / Language",        "sidebar.cities_error": "Impossible de charger les villes depuis la base.",        "sidebar.footer": "Données publiques de qualité de l'air · Connexion admin pour la gestion",
        # ── auth ──
        ...
        "auth.invalid_credentials": "Identifiant ou mot de passe invalide.",        "auth.access_denied": "Accès refusé — rôle {role} requis.",        "auth.role_admin": "admin",
        "auth.role_viewer": "lecteur",

        # ── HQ Overview ──
        "hq.title": "Vue d'ensemble",        "hq.caption": "_Puis-je respirer l'air aujourd'hui ? — Réponse en 5 secondes_",
        "hq.aqi_today": "AQI aujourd'hui",        "hq.cities_in_alert": "Villes en alerte",        "hq.data_completeness": "Complétude des données",        "hq.days_without_alert": "Jours sans alerte",        "hq.aqi_evolution": "Évolution de l'AQI",        "hq.aqi_map": "Carte de la qualité de l'air",        "hq.aqi_distribution": "Répartition de l'AQI",        "hq.worst_pollutant": "Pire polluant vs seuil OMS",        "hq.pct_of_who": "{pct}% de la limite OMS ({thr} µg/m³)",
        "hq.pct_of_who_threshold": "{pct}% du seuil OMS",
        "hq.who_exceedance": "Taux de dépassement OMS",        "hq.readings_exceeding": "Mesures dépassant les limites OMS",
        "hq.pipeline_health": "Santé du pipeline",        "hq.status_up_to_date": "À jour",
        "hq.status_delayed": "En retard",
        "hq.status_critical": "Critique",
        "hq.measure": "Mesure",
        "hq.measurements": "Mesures",
        "hq.aqi_level": "Niveau d'AQI",
        "hq.exec_attention": "Points d'attention & recommandations",        "hq.exec_caption": "_Généré automatiquement depuis les dernières données_",
        "hq.attention_best_city": "Meilleure ville aujourd'hui : **{city}** (AQI {aqi})",        "hq.attention_worst_city": "Ville la plus polluée aujourd'hui : **{city}** (AQI {aqi})",        "hq.attention_worst_pollutant": "Pire polluant : **{pollutant}** à {pct}% du seuil OMS",        "hq.attention_cities_alert": "{n} ville(s) en alerte actuellement",        "hq.attention_trend_up": "L'AQI est en hausse de {delta} vs hier",        "hq.attention_trend_down": "L'AQI a baissé de {delta} vs hier",        "hq.attention_trend_flat": "AQI stable vs hier ({delta})",        "hq.attention_no_alerts": "Aucune ville en alerte — bonne qualité de l'air",        "hq.attention_gap": "{pct}% de complétude des données — vérifier le pipeline",
        ...
        "deep.boxplot": "Boîte à moustaches — AQI par mois",        "deep.boxplot_caption": "_Détection de valeurs aberrantes : les points au-delà des moustaches sont des mesures inhabituelles_",
        "deep.boxplot_title": "Répartition de l'AQI par mois",
        "deep.scatter": "PM2.5 vs AQI",        "deep.scatter_caption": "_Avec ligne de tendance de régression linéaire_",
        "deep.ols_warning": "Ligne OLS indisponible (statsmodels non installé). Affichage sans tendance.",        "deep.heatmap": "Carte de chaleur — AQI par heure × jour",        "deep.heatmap_caption": "_Vue multi-dimensionnelle : plus sombre = air de moins bonne qualité_",
        "deep.corr_matrix": "Matrice de corrélation des polluants",        "deep.corr_caption": "_1.0 = corrélation parfaite, 0 = aucune, -1 = inverse_",
        "deep.key_insight": "**Point clé :** l'AQI est le plus corrélé avec PM2.5 ({pm25}) et PM10 ({pm10})",        "deep.monthly_stats": "Distribution statistique mensuelle",        "deep.seasonal": "Analyse saisonnière",        "deep.seasonal_title": "Saison sèche vs saison des pluies",
        "deep.weekday_weekend": "Jour de semaine vs week-end",        "deep.weekday_weekend_title": "Effet jour de semaine vs week-end",
        ...
        # ── City Comparison ──
        "compare.title": "Comparateur de villes",        "compare.caption": "_Comment les villes se comparent-elles maintenant et sur la dernière semaine ?_",
        "compare.mode": "Mode",
        "compare.mode_all": "Toutes les villes",
        "compare.mode_2cities": "Comparer 2 villes",
        "compare.city_a": "Ville A",
        "compare.city_b": "Ville B",
        "compare.best_air": "Meilleur air",        "compare.worst_air": "Pire air",        "compare.cities_count": "Villes",        "compare.current_aqi_by_city": "AQI actuel par ville",        "compare.current_aqi": "AQI actuel",
        "compare.trend_7d_title": "Tendance AQI sur 7 jours",        "compare.avg_aqi": "AQI moyen",
        "compare.ranking": "Classement",        "compare.versus": "{a} vs {b}",        "compare.aqi_now": "AQI maintenant",
        "compare.aqi_diff": "{a} vs {b}",
        "compare.winner": "Meilleur air : **{city}**",        "compare.pollutant_compare": "Comparaison des polluants",        "compare.avg_this_week": "Moyenne sur 7 jours",
        "compare.same_city": "Choisissez deux villes différentes pour comparer.",
        # ── Compare captions ──
        ...
        # ── Alerts / Control room ──
        "alerts.title": "Salle de contrôle & alertes",        "alerts.caption": "_Historique des épisodes où l'AQI a atteint le niveau d'alerte (≥ 3)_",
        "alerts.last_days": "Derniers {d} jours",
        "alerts.no_alerts": "Aucun épisode d'alerte sur cette période — excellente qualité de l'air !",        "alerts.total_alerts": "Total d'alertes",        "alerts.worst_episode": "Pire épisode",        "alerts.cities_affected": "Villes touchées",        "alerts.alerts_per_city": "Alertes par ville",        "alerts.alerts": "Alertes",
        "alerts.worst_aqi": "Pire AQI",
        "alerts.severity": "Sévérité",
        "alerts.severity_all": "Toutes",
        "alerts.level_alert": "Alerte",
        "alerts.level_severe": "Sévère",
        "alerts.recent_episodes": "Épisodes récents",        "alerts.control_title": "État en direct des villes",        "alerts.control_caption": "_Rafraîchi automatiquement toutes les 30 secondes_",
        ...
        # ── Forecast ──
        "forecast.title": "Prévision AQI",        "forecast.caption": "_Prévision AQI sur 7 jours par ville (ARIMA, avec repli moyenne mobile)_",
        ...
        "forecast.next_7d_avg": "Moyenne 7 prochains jours",        "forecast.day7": "Jour 7",        "forecast.trend_metric": "Tendance",        "forecast.improving": "Amélioration ",
        "forecast.worsening": "Dégradation ",
        "forecast.stable": "Stable ",
        "forecast.history_forecast": "Historique + Prévision — {city}",        "forecast.history": "Historique",
        "forecast.forecast_series": "Prévision",
        "forecast.details": "Détails de la prévision",        "forecast.ci": "IC 80%",
        "forecast.horizon": "Horizon de prévision",
        "forecast.days": "{d} jours",
        "forecast.next_days_avg": "Moyenne {h} prochains jours",
        "forecast.day_h": "Jour {h}",

        # ── Forecast captions ──
        "forecast.history_forecast_caption": "_Historique observé et prévision sur {h} jours avec intervalle de confiance_",

        # ── Pipeline Monitor ──
        "pipeline.title": "Monitoring technique",        "pipeline.caption": "_Panneau admin — santé et qualité du pipeline de données_",
        "pipeline.status": "Statut du pipeline",        "pipeline.last_ingestion": "Dernière ingestion",        "pipeline.last_record": "Dernier enregistrement",
        "pipeline.data_completeness": "Complétude des données",        "pipeline.today": "Aujourd'hui",
        "pipeline.records_per_day": "Enregistrements par jour (7 derniers jours)",        "pipeline.records": "Enregistrements",
        "pipeline.missing_data": "Détection des données manquantes (24 dernières heures)",        "pipeline.complete_records": "Enregistrements complets",        "pipeline.missing_records": "Enregistrements manquants",        "pipeline.missing_warning": "{n} enregistrements manquants sur {total}",        "pipeline.no_missing": "Aucune donnée manquante sur les 24 dernières heures",        "pipeline.complete": "Complet",
        ...
        # ── User Management ──
        "users.title": "Gestion des utilisateurs",        "users.caption": "_Gérez l'accès admin — utilisateurs stockés en local, NeonDB inchangée._",
        "users.search": "Rechercher par nom ou email…",
        "users.role_filter": "Rôle",
        "users.role_all": "Tous les rôles",
        "users.active_only": "Comptes actifs uniquement",
        "users.create": "Créer un utilisateur",        "users.email_optional": "Email (optionnel, pour la connexion Google)",
        ...
        "explorer.quick": "Requêtes rapides",        "explorer.pick": "Choisir une requête",
        "explorer.custom": "— SQL personnalisé —",
        "explorer.sql_label": "SQL (lecture seule)",
        "explorer.run": ":material/play_arrow: Exécuter la requête",
        ...
        "explorer.read_only": "Seules les requêtes en lecture seule (SELECT / WITH / EXPLAIN) sont autorisées.",        "explorer.running": "Exécution de la requête...",
        "explorer.rows": "{n} ligne(s) renvoyée(s).",        "explorer.single_statement": "Une seule instruction est autorisée — les points-virgules sont rejetés.",

        # ── Citizens page ──
        "citizens.title": "Info citoyens & santé publique",        "citizens.caption": "_Comprendre la qualité de l'air et protéger sa santé — en langage simple_",
        "citizens.understand_aqi": "Comprendre l'indice AQI",        "citizens.aqi_explained": "L'indice de qualité de l'air (AQI) va de **1 (excellent)** à **5 (dangereux)**. Plus il est élevé, plus l'air est pollué et plus les effets sur la santé peuvent être graves.",
        "citizens.what_to_do": "Que faire selon le niveau ?",        "citizens.vulnerable": "Groupes vulnérables",        "citizens.vulnerable_text": "Les **enfants**, les **personnes âgées**, les **femmes enceintes** et les personnes souffrant d'**asthme** ou de **maladies cardiaques** sont les plus sensibles à la pollution de l'air.",
        "citizens.pollutants": "Les polluants surveillés",        "citizens.pm25_text": "Poussières fines (PM2.5) : pénètrent profondément dans les poumons et le sang.",
        ...
        "citizens.who_health": "Dépassements des seuils OMS par ville",        "citizens.who_health_caption": "_Pourcentage de jours où la concentration dépasse la ligne directrice OMS 24h (7 derniers jours)_",
        "citizens.realtime": "Qualité de l'air en ce moment",        "citizens.realtime_caption": "_Badges en direct pour chaque ville (mise à jour manuelle via rechargement)_",
    ...
    "en": {
        # ── common ──
        "common.db_error": "Database error: {msg}",        "common.no_data": "No data available",
        ...
        # ── navigation ──
        "nav.hq_overview": "HQ Overview",        "nav.city_drilldown": "City Drill-down",        "nav.deep_analysis": "Deep Analysis",        "nav.city_comparison": "City Comparison",        "nav.alerts_history": "Alerts & Control Room",        "nav.forecast": "AQI Forecast",        "nav.citizens": "Citizens & Health Info",        "nav.pipeline_monitor": "Pipeline Monitor",        "nav.user_management": "User Management",        "nav.data_explorer": "Data Explorer",
        ...
        "sidebar.sign_out": "Sign out",        "sidebar.public_viewer": "Public viewer — data is open",
        "sidebar.navigation": "Navigation",
        "sidebar.subtitle": "Air quality · Madagascar",
        "sidebar.filters": "Filters",
        "sidebar.language": "Language / Langue",        "sidebar.cities_error": "Could not load cities from database.",        "sidebar.footer": "Public air quality data · Admin login for management",
        # ── auth ──
        ...
        "auth.invalid_credentials": "Invalid username or password.",        "auth.access_denied": "Access denied — {role} role required.",        "auth.role_admin": "admin",
        "auth.role_viewer": "viewer",

        # ── HQ Overview ──
        "hq.title": "HQ Overview",        "hq.caption": "_Can I trust the air today? — Answered in 5 seconds_",
        "hq.aqi_today": "AQI Today",        "hq.cities_in_alert": "Cities in Alert",        "hq.data_completeness": "Data Completeness",        "hq.days_without_alert": "Days Without Alert",        "hq.aqi_evolution": "AQI Evolution",        "hq.aqi_map": "Air Quality Map",        "hq.aqi_distribution": "AQI Distribution",        "hq.worst_pollutant": "Worst Pollutant vs WHO Threshold",        "hq.pct_of_who": "{pct}% of WHO limit ({thr} µg/m³)",
        "hq.pct_of_who_threshold": "{pct}% of WHO threshold",
        "hq.who_exceedance": "WHO Exceedance Rate",        "hq.readings_exceeding": "Readings exceeding WHO limits",
        "hq.pipeline_health": "Pipeline Health",        "hq.status_up_to_date": "Up to date",
        "hq.status_delayed": "Delayed",
        "hq.status_critical": "Critical",
        "hq.measure": "Measure",
        "hq.measurements": "Measurements",
        "hq.aqi_level": "AQI Level",
        "hq.exec_attention": "Key Points & Recommendations",        "hq.exec_caption": "_Auto-generated from the latest data_",
        "hq.attention_best_city": "Best city today: **{city}** (AQI {aqi})",        "hq.attention_worst_city": "Most polluted city today: **{city}** (AQI {aqi})",        "hq.attention_worst_pollutant": "Worst pollutant: **{pollutant}** at {pct}% of the WHO limit",        "hq.attention_cities_alert": "{n} city/cities in alert right now",        "hq.attention_trend_up": "AQI up by {delta} vs yesterday",        "hq.attention_trend_down": "AQI down by {delta} vs yesterday",        "hq.attention_trend_flat": "AQI stable vs yesterday ({delta})",        "hq.attention_no_alerts": "No city in alert — good air quality",        "hq.attention_gap": "{pct}% data completeness — check the pipeline",
        # ── HQ captions (panel descriptions) ──
        ...
        "deep.boxplot": "Boxplot — AQI by Month",        "deep.boxplot_caption": "_Outlier detection: dots beyond whiskers are unusual readings_",
        "deep.boxplot_title": "AQI Distribution by Month",
        "deep.scatter": "PM2.5 vs AQI",        "deep.scatter_caption": "_With linear regression trendline_",
        "deep.ols_warning": "OLS trendline unavailable (statsmodels not installed). Showing scatter without trendline.",        "deep.heatmap": "Heatmap — AQI by Hour × Day",        "deep.heatmap_caption": "_Multi-dimensional view: darker = worse air quality_",
        "deep.corr_matrix": "Pollutant Correlation Matrix",        "deep.corr_caption": "_1.0 = perfect correlation, 0 = none, -1 = inverse_",
        "deep.key_insight": "**Key insight:** AQI is most correlated with PM2.5 ({pm25}) and PM10 ({pm10})",        "deep.monthly_stats": "Monthly Statistical Distribution",        "deep.seasonal": "Seasonal Analysis",        "deep.seasonal_title": "Dry Season vs Wet Season",
        "deep.weekday_weekend": "Weekday vs Weekend",        "deep.weekday_weekend_title": "Weekday vs Weekend Effect",
        ...
        # ── City Comparison ──
        "compare.title": "City Comparison",        "compare.caption": "_How do cities compare right now and over the last week?_",
        "compare.mode": "Mode",
        "compare.mode_all": "All cities",
        "compare.mode_2cities": "Compare 2 cities",
        "compare.city_a": "City A",
        "compare.city_b": "City B",
        "compare.best_air": "Best Air",        "compare.worst_air": "Worst Air",        "compare.cities_count": "Cities",        "compare.current_aqi_by_city": "Current AQI by City",        "compare.current_aqi": "Current AQI",
        "compare.trend_7d_title": "7-Day AQI Trend",        "compare.avg_aqi": "Average AQI",
        "compare.ranking": "Ranking",        "compare.versus": "{a} vs {b}",        "compare.aqi_now": "AQI now",
        "compare.aqi_diff": "{a} vs {b}",
        "compare.winner": "Best air: **{city}**",        "compare.pollutant_compare": "Pollutant Comparison",        "compare.avg_this_week": "7-day average",
        "compare.same_city": "Pick two different cities to compare.",
        # ── Compare captions ──
        ...
        # ── Alerts / Control room ──
        "alerts.title": "Alerts & Control Room",        "alerts.caption": "_History of episodes where AQI reached alert level (≥ 3)_",
        "alerts.last_days": "Last {d} days",
        "alerts.no_alerts": "No alert episodes in this period — great air quality!",        "alerts.total_alerts": "Total Alerts",        "alerts.worst_episode": "Worst Episode",        "alerts.cities_affected": "Cities Affected",        "alerts.alerts_per_city": "Alerts per City",        "alerts.alerts": "Alerts",
        "alerts.worst_aqi": "Worst AQI",
        "alerts.severity": "Severity",
        "alerts.severity_all": "All",
        "alerts.level_alert": "Alert",
        "alerts.level_severe": "Severe",
        "alerts.recent_episodes": "Recent Episodes",        "alerts.control_title": "Live City Status",        "alerts.control_caption": "_Auto-refreshes every 30 seconds_",
        "alerts.now": "Now",
        ...
        # ── Forecast ──
        "forecast.title": "AQI Forecast",        "forecast.caption": "_7-day AQI forecast per city (ARIMA, with moving-average fallback)_",
        ...
        "forecast.next_7d_avg": "Next 7d Avg",        "forecast.day7": "Day 7",        "forecast.trend_metric": "Trend",        "forecast.improving": "Improving ",
        "forecast.worsening": "Worsening ",
        "forecast.stable": "Stable ",
        "forecast.history_forecast": "History + Forecast — {city}",        "forecast.history": "History",
        "forecast.forecast_series": "Forecast",
        "forecast.details": "Forecast Details",        "forecast.ci": "80% CI",
        "forecast.horizon": "Forecast horizon",
        "forecast.days": "{d} days",
        "forecast.next_days_avg": "Next {h} days avg",
        "forecast.day_h": "Day {h}",

        # ── Forecast captions ──
        "forecast.history_forecast_caption": "_Observed history and {h}-day forecast with confidence interval_",

        # ── Pipeline Monitor ──
        "pipeline.title": "Pipeline Monitor",        "pipeline.caption": "_Admin panel — data pipeline health and quality_",
        "pipeline.status": "Pipeline Status",        "pipeline.last_ingestion": "Last Ingestion",        "pipeline.last_record": "Last Record",
        "pipeline.data_completeness": "Data Completeness",        "pipeline.today": "Today",
        "pipeline.records_per_day": "Records per Day (Last 7 Days)",        "pipeline.records": "Records",
        "pipeline.missing_data": "Missing Data Detection (Last 24h)",        "pipeline.complete_records": "Complete Records",        "pipeline.missing_records": "Missing Records",        "pipeline.missing_warning": "{n} missing records detected out of {total}",        "pipeline.no_missing": "No missing data in the last 24 hours",        "pipeline.complete": "Complete",
        ...
        # ── User Management ──
        "users.title": "User Management",        "users.caption": "_Manage admin access — users are stored locally, NeonDB stays untouched._",
        "users.search": "Search by name or email…",
        "users.role_filter": "Role",
        "users.role_all": "All roles",
        "users.active_only": "Active accounts only",
        "users.create": "Create user",        "users.email_optional": "Email (optional, for Google login)",
        ...
        "explorer.quick": "Quick Queries",        "explorer.pick": "Pick a query",
        "explorer.custom": "— custom SQL —",
        "explorer.sql_label": "SQL (read-only)",
        "explorer.run": ":material/play_arrow: Run query",
        "explorer.hint": "Only SELECT / WITH / EXPLAIN. Results capped at {max} rows.",
        "explorer.write_query": "Please write a query first.",
        "explorer.read_only": "Only read-only queries (SELECT / WITH / EXPLAIN) are allowed.",        "explorer.running": "Running query...",
        "explorer.rows": "{n} row(s) returned.",        "explorer.single_statement": "Only one statement is allowed — semicolons are rejected.",

        # ── Citizens page ──
        "citizens.title": "Citizens & Health Info",        "citizens.caption": "_Understand air quality and protect your health — in plain language_",
        "citizens.understand_aqi": "Understanding the AQI",        "citizens.aqi_explained": "The Air Quality Index (AQI) runs from **1 (excellent)** to **5 (hazardous)**. The higher it is, the more polluted the air and the more severe the possible health effects.",
        "citizens.what_to_do": "What to do by level?",        "citizens.vulnerable": "Vulnerable Groups",        "citizens.vulnerable_text": "**Children**, **elderly people**, **pregnant women** and people with **asthma** or **heart disease** are the most sensitive to air pollution.",
        "citizens.pollutants": "Monitored Pollutants",        "citizens.pm25_text": "Fine particles (PM2.5): penetrate deep into the lungs and bloodstream.",
        ...
        "citizens.who_health": "WHO threshold exceedances by city",        "citizens.who_health_caption": "_Share of days where the concentration exceeds the WHO 24h guideline (last 7 days)_",
        "citizens.realtime": "Live air quality",        "citizens.realtime_caption": "_Live badges for each city (refresh to update)_",
