"""Dashboard 2 — City Drill-down: 5 panels per city."""
        ...
        with st.container(border=True):
            ...
            if not df_comp.empty:
                fig = px.bar(df_comp, x="metric", y=["city_val", "national_val"],
                             barmode="group", labels={"value": "Value", "metric": "Metric"},
                             color_discrete_map={"city_val": "#1E88E5", "national_val": "#FF7043"})
    ...
    with st.container(border=True):
        ...
        if not df_hourly.empty:
            fig = px.bar(df_hourly, x="hour", y=["avg_aqi", "avg_pm25", "avg_o3"],
                         barmode="group", labels={"value": "Average", "hour": "Hour of Day"},
