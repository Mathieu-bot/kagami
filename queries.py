...
def city_vs_national(city_name: str):
    ...
    return query(f"""
        ...
        SELECT 'AQI' AS metric, city.aqi AS city_val, nat.aqi AS national_val FROM city_avg city, national_avg nat
        UNION ALL SELECT 'PM2.5', city.pm25, nat.pm25 FROM city_avg city, national_avg nat
        UNION ALL SELECT 'PM10', city.pm10, nat.pm10 FROM city_avg city, national_avg nat
        UNION ALL SELECT 'NO₂', city.no2, nat.no2 FROM city_avg city, national_avg nat
        UNION ALL SELECT 'O₃', city.o3, nat.o3 FROM city_avg city, national_avg nat
    """)
